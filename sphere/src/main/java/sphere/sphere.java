...
import common.CreateCylinder;
import common.CreateSphere;
import common.CreateTorus;
import jrtr.*;
...
{	
	...
	public final static class SphereRenderPanel extends GLRenderPanel
	{
		...
		public void init(RenderContext r)
		{
			...
			CreateSphere torus = new CreateSphere(32, 32, 1.0f, r);
	 ...
	 */
	public static class SphereMouseListener implements MouseListener
	{
	 ...
	 */
	public static class SphereKeyListener implements KeyListener
	{
	...
	{		
		...
		renderPanel = new SphereRenderPanel(firstArg);
	    ...
	    renderPanel.getCanvas().addMouseListener(new SphereMouseListener());
	    renderPanel.getCanvas().addKeyListener(new SphereKeyListener());
