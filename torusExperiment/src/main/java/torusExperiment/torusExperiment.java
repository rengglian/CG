...
{	
	...
	public final static class TorusRenderPanel extends GLRenderPanel
	{
		...
		public void init(RenderContext r)
		{
			...
			CreateTorus torus = new CreateTorus(32, 32, 2.0f, 1.0f, r);
		    ...
		    try {
		    	diffuseShader.load("../jrtr/shaders/Experiment.vert", "../jrtr/shaders/Experiment.frag");
		    } catch(Exception e) {
		    	System.out.print("Problem with shader:\n");
		    	System.out.print(e.getMessage());
		    }
			...
			firstLight.diffuse = new Vector3f(0.0f, 0.0f, 1.0f);
			...
			secondLight.diffuse = new Vector3f(1.0f, 0.0f, 0.0f);
			secondLight.position = new Vector3f(5.0f, 0.0f, 1.0f);
			secondLight.direction = new Vector3f(.0f, .0f, 1.0f);
